...
Production URL: https://chlebicek.vercel.app. Builds include canonical URLs, absolute OG URLs, populated sitemap and indexing; SITE_URL can override the domain. Configure production host to serve 404.html with status 404. Confirm hosting provider and access-log retention for privacy notice. Local preview includes correct 404 handling.
